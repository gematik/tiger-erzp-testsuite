...
#Test für APS
#Testfall prüft das Übermitteln von Nachrichten. Vorbedingungen:
#   1) AuthNToken anfordern für VPS,
#   2) E-Rezept erzeugen,
#   3) E-Rezept einstellen,
#   4) Nachricht durch Patient einstellen,
#   5) AuthNToken anfordern für APS,
#   6) Nachricht empfangen

@APS_AF4x7_002
@APS
Funktion: eRp abgebend - ERP_APS_AF4x7_002 - GF Nachricht übermitteln
  ...
  @APS
  Szenario: Vorbedingung: Apotheke liest Nachricht
    Gegeben sei TGR pausiere Testausführung mit Nachricht "Bitte lesen Sie die Nachricht für die Patienten-Communikation-Id: ${erp.patient_communication_id}"
  ...
  @APS
  Szenario: Nachricht übermitteln
    Gegeben sei TGR pausiere Testausführung mit Nachricht "Bitte übermitteln Sie eine neue Nachricht für die Knvr: ${erp.kvnr}"
