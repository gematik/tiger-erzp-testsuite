...
@APS_AF4x4_001
@APS
Funktion: eRp abgebend - ERP_APS_AF4x4_001 - GF E-Rezept Quittung abrufen
  ...
  Szenario: Quittung abrufen
    Gegeben sei TGR pausiere Testausführung mit Nachricht "Bitte rufen Sie die Quittung für das E-Rezept mit TaskId: ${erp.task_id} und TaskSecret: ${erp.task_secret}  ab."
