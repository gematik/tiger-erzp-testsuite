...
@APS_AF4x3_001
@APS
Funktion: eRp abgebend - ERP_APS_AF4x3_001 - GF E-Rezept durch Abgebenden löschen
  ...
  @APS
  Szenario: E-Rezept löschen
    Gegeben sei TGR pausiere Testausführung mit Nachricht "Bitte löschen Sie das E-Rezept mit TaskId: ${erp.task_id} und TaskSecret: ${erp.task_secret}"
