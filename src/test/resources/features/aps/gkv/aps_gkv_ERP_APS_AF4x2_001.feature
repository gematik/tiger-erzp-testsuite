...
#Test für APS
#Testfall prüft das Zurückgeben eines E-Rezeptes

@APS_AF4x2_001
@APS
Funktion: eRp abgebend - ERP_APS_AF4x2_001 - GF E-Rezept zurückgeben
  ...
  @APS
  Szenario: E-Rezept zurückgeben
    Gegeben sei TGR pausiere Testausführung mit Nachricht "Bitte geben Sie als Apotheker das E-Rezept mit TaskId: ${erp.task_id} und TaskSecret: ${erp.task_secret} zurück."
    Und TGR finde die letzte Anfrage mit Pfad ".*" und Knoten "$.body.message.path.basicPath" der mit "/Task/${erp.task_id}/$reject" übereinstimmt
