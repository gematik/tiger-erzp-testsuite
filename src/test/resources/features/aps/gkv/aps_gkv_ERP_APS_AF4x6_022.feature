...
#Test für APS
#Testfall prüft das Empfangen von ungelesenen Nachrichten. Zu erfüllende Vorbedingungen:
...
@APS_AF4x6_022
@APS
Funktion: eRp abgebend - ERP_APS_AF4x6_022 - GF Nachricht empfangen (ungelesen)
  ...
  @APS
  Szenario: Nachricht empfangen (ungelesen)
    Gegeben sei TGR pausiere Testausführung mit Nachricht "Bitte rufen Sie die empfangenen Nachrichten ab."
