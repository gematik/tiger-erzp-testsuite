...
@APS_AF4x6_011
@APS
Funktion: eRp abgebend - ERP_APS_AF4x6_011 - GF Nachricht empfangen (Token)
  Grundlage:
  ...
  Szenario: Token empfangen
    Gegeben sei TGR pausiere Testausführung mit Nachricht "Bitte rufen Sie alle empfangenen Nachrichten ab und akzeptieren Sie das letzte E-Rezept von der KVNR: ${erp.patient_kvnr}."
