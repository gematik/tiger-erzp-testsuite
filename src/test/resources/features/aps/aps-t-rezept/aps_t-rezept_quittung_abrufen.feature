...
#Test für APS
#Testfall prüft das Abrufen einer Quittung für ein E-Rezept.
#        * AuthN-Token anfordern für VPS
#        * E-Rezept erzeugen
#        * E-Rezept einstellen
#        * AuthN-Token anfordern für APS
#        * E-Rezept abrufen
@APS_T-REZEPT_QUITTUNG_ABRUFEN
@APS_T-REZEPT
Funktion: eRp abgebend - GF T-Rezept Quittung abrufen
  ...
  @APS_T-REZEPT
  Szenario: Vorbedingung: Als Apotheker das E-Rezept akzeptieren
    Gegeben sei TGR pausiere Testausführung mit Nachricht "Bitte rufen Sie als Apotheker das E-T-Rezept mit TaskId: ${erp.task_id} und AccessCode: ${erp.task_access_code} ab."
  ...
  @APS_T-REZEPT
  Szenario: Quittung abrufen
    Gegeben sei TGR pausiere Testausführung mit Nachricht "Bitte rufen Sie die Quittung für das E-T-Rezept mit TaskId: ${erp.task_id} und TaskSecret: ${erp.task_secret}  ab."
